...
const OrderStatus = [
    ...
    { lable: "Cencelled", value: "cencelled" },
...
const Order = () => {
    return (
        <div className="px-5 lg:px-20">
            <Grid container sx={{ justifyContent:"space-center"}}>
                <Grid item xs={2.5}>
                    <div className="h-auto shadow-lg bg-white p-5 sticky top-5">
                        ...
                        <div className="space-y-4 mt-10">
                            ...
                            {OrderStatus.map((Option) => <div className="flex items-center">
                                    ...
                                    <label className="ml-3 block text-sm font-medium text-gray-700" htmlFor={Option.value}>
                                        {Option.lable}
                                    </label>
                            </div> )}
                        </div> 
